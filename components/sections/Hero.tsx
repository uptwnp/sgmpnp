  ...
  const slides = [
    {
      ...
      description: "Discover world-class industrial developments with modern infrastructure, RERA compliance, and exceptional growth potential.",
      image: "https://images.pexels.com/photos/1105766/pexels-photo-1105766.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop"
    },
    {
      title: "Smart Investment",
      subtitle: "Opportunities",
      description: "Secure your future with industrial plots starting from ₹27,000 per sq yard. Flexible payment plans and transparent pricing.",
    ...
    },
    {
      ...
      description: "24x7 security, power backup, water supply, and excellent connectivity to major highways and industrial hubs.",
      image: "https://images.pexels.com/photos/1105766/pexels-photo-1105766.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop"
    }
  ];
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-poppins leading-tight text-shadow">
                <span className="block text-white">Sigma Industrial Park Panipat</span>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-200 leading-relaxed max-w-4xl mx-auto px-4">
                Premium RERA approved industrial plots in Panipat, Haryana with world-class infrastructure, strategic NH-07 location, and flexible payment plans starting ₹27,000 per sq yard.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto px-4">
              <div className="glass-effect rounded-2xl p-6 text-center hover-lift backdrop-blur-md">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 font-poppins">15+</h3>
                <p className="text-sm sm:text-base text-blue-200 font-medium">Years Experience</p>
              </div>
              <div className="glass-effect rounded-2xl p-6 text-center hover-lift backdrop-blur-md">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 font-poppins">₹27K+</h3>
                <p className="text-sm sm:text-base text-blue-200 font-medium">Starting Price/Sq Yd</p>
              </div>
              <div className="glass-effect rounded-2xl p-6 text-center hover-lift backdrop-blur-md">
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 font-poppins">2</h3>
                <p className="text-sm sm:text-base text-blue-200 font-medium">Premium Locations</p>
              </div>
            </div>
