...
export const metadata = {
  title: 'Sigma Industrial Park 1 Panipat | RERA Approved Industrial Plots NH-07',
  description: 'Sigma Industrial Park 1 at Mauli, Barwala, NH-07 Panipat. RERA approved industrial plots 300-3000 sq yards, modern infrastructure, 24x7 security. Book with ₹5 lakhs token.',
  keywords: 'Sigma Industrial Park 1, industrial plots panipat, RERA approved panipat, NH-07 industrial park, Mauli Barwala industrial plots, Sigma Group Panipat',
};

export default function IndustrialPark1() {
  const features = [
  ...
  const specifications = [
    { label: 'Location', value: 'Mauli, Barwala, NH-07, Panchkula' },
    { label: 'RERA Number', value: 'HRERA-PKL-PKL-503-2023' },
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 leading-relaxed mb-6 sm:mb-8 px-4">
              Premium industrial development with world-class infrastructure and strategic highway connectivity for modern businesses.
            </p>
            ...
            <div className="flex flex-col gap-4 justify-center px-4">
              <Link href="/contact">
                <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-full btn-hover-scale">
                  Book Site Visit
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </Link>
              <Link href="/contact">
                <Button variant="outline" className="w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-full btn-hover-scale">
                  Get Information
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="relative h-64 sm:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-2xl hover-lift">
              <img
                src="https://images.pexels.com/photos/1105766/pexels-photo-1105766.jpeg?auto=compress&cs=tinysrgb&w=1200&h=600&fit=crop"
                alt="Sigma Industrial Park 1"
                className="w-full h-full object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" />
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6">
                <h3 className="text-lg sm:text-2xl font-bold text-white mb-2">Modern Industrial Infrastructure</h3>
                <p className="text-sm sm:text-base text-white/90">World-class facilities designed for business success</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-gray-600 px-4">
                Detailed information about Sigma Industrial Park 1
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-gray-600 px-4">
                Strategic benefits of Mauli, Barwala location on NH-07
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              <Card className="hover:shadow-lg transition-shadow duration-300 border-0 hover-lift">
                ...
                <CardContent className="space-y-2 sm:space-y-3">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">• 1 km from Mauli town center</p>
                  <p className="text-sm sm:text-base text-gray-600">• 25 km from Panchkula city</p>
                  <p className="text-sm sm:text-base text-gray-600">• Easy connectivity to major industrial areas</p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300 border-0 hover-lift">
                ...
                <CardContent className="space-y-2 sm:space-y-3">
                  <p className="text-sm sm:text-base text-gray-600">• Developed internal road network</p>
                  <p className="text-sm sm:text-base text-gray-600">• Reliable power supply with backup</p>
                  <p className="text-sm sm:text-base text-gray-600">• Water supply and sewage systems</p>
                  <p className="text-sm sm:text-base text-gray-600">• High-speed internet connectivity</p>
                </CardContent>
              </Card>
            </div>
          </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div className="text-center p-4 sm:p-6 bg-blue-50 rounded-xl">
                      <h4 className="text-xl sm:text-2xl font-bold text-blue-600 mb-2">Below ₹30K</h4>
                  ...
                  <div className="space-y-2 sm:space-y-3 text-left">
                    ...
                    <div className="flex items-center gap-3 text-sm sm:text-base">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0" />
                      <span className="text-gray-700">RERA registered for legal security</span>
                    </div>
                    <div className="flex items-center gap-3 text-sm sm:text-base">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-3 text-sm sm:text-base">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0" />
                      <span className="text-gray-700">Ready for immediate possession</span>
                    </div>
                  </div>
